...
resourcegroup_name = 'won'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'won'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
car.Price = 50000
table_service.insert_entity('itemstable', car)
print('Created entry for cadilac...\n')
